...
class _AdminProductScreenState extends State<AdminProductScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Quản Lý Thực Đơn", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
        actions: [
          IconButton(
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected ? const Color(0xFFFFB039) : Colors.grey[100],
  ...
  Widget _buildStatusChip(String label, String value, [Color color = Colors.blue]) {
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text("#${product.id}", style: const TextStyle(color: Colors.white, fontSize: 10)),
                  ),
                ),
                // if (isHidden)
                //   const Center(
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(fontWeight: FontWeight.bold, color: isHidden ? Colors.grey : Colors.black),
                ),
                ...
                Row(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(color: isHidden ? Colors.grey : Colors.red, fontWeight: FontWeight.bold),
                    ),
